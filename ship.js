(function () {
  ...
  function initializeWaves() {
    var randomWave1 = randomIntFromInterval(4, 5);
    var randomWave2 = randomIntFromInterval(2, 3);
    var randomWave3 = randomIntFromInterval(6, 7);

    for (var x = 0; x < screenWidth; x++) {
      wave[x] =
        (value(x, screenWidth, randomWave1) * multiplier(x, screenWidth)) / 4;
      wave2[x] =
        (value(x, screenWidth, randomWave2) * multiplier(x * 3, screenWidth)) /
        6;
      wave3[x] = value(x, screenWidth, randomWave3);
    }
